package twitter
{
	...
	public class YFrog extends EventDispatcher implements ITwitterService
	{

		private static var _instance:YFrog;
		...
		public function uploadToService(_file:File, _message:String = null):void
		{
			...
			if (_message)
			{
				urlRequest = new URLRequest("http://yfrog.com/api/uploadAndPost");
		...
		{
			//trace("Upload is complete, recieved response from YFrog.");
		...
		public static function get instance():YFrog
		{
			if (!_instance)
			{
				_instance = new YFrog();
