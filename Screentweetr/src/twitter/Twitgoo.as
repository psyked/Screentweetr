package twitter
{
	...
	public class Twitgoo extends EventDispatcher implements ITwitterService
	{

		private static var _instance:Twitgoo;
		private var file:File;
		private var developerKey:String = "";

		public function Twitgoo()
		{
			//
		}
		...
		public function uploadToService(_file:File, _message:String = null):void
		{
			...
			//urlVars.key  =developerKey;
			//urlVars.source = "Screentweetr";
			
			if (_message)
			{
				urlRequest = new URLRequest("http://twitgoo.com/api/uploadAndPost");
				urlVars.message = _message;
			}
			else
			{
				urlRequest = new URLRequest("http://twitgoo.com/api/upload");
			}
		...
		{
			//trace("Upload is complete, recieved response from Twitgoo.");
		...
		public static function get instance():Twitgoo
		{
			if (!_instance)
			{
